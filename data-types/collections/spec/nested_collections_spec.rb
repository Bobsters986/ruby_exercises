RSpec.describe 'Nested Collections' do
  ...
  it 'test 9' do
    ...
    num_fielders = team.values[1].count
  ...
  it 'test 10' do
    ...
    kenny_is_pitcher = team.values[0].include?("Kenny")
  ...
  it 'test 11' do
    ...
    actual = three_day_forecast.values[2]
  ...
  it 'test 12' do
    ...
    actual = three_day_forecast.values[0]
  ...
  it 'test 13' do
    ...
    actual = three_day_forecast.values[1]
    expected = "6-21-18"
    expect(actual).to eq(expected)
  end
  ...
  it 'test 15' do
    ...
    actual = three_day_forecast.values[0][1].values[0]
    expected = 55
    expect(actual).to eq(expected)
  end
  ...
  it 'test 16' do
    ...
    actual = three_day_forecast.values[0][0].keys
  ...
  it 'test 17' do
    ...
    actual = three_day_forecast.values[0][2].values
